...
namespace ExportService.Services
{
    ...
    {
        public byte[] GenerateExcelGroupedByEvent(List<Models.ExportTransaction> transactions)
        {

            using var package = new ExcelPackage();
            // No need to set license context here as it's set at the application level
